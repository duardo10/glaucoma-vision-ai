      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            <Link href="/analise" className="hidden md:block btn btn-primary btn-sm">
              Nova Análise
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-2 border-t border-gray-200">
            ...
            <div className="mt-2 px-4 py-2">
              <Link href="/analise" className="w-full btn btn-primary text-center" onClick={() => setMobileMenuOpen(false)}>
                Nova Análise
              </Link>
            </div>
          </div>
